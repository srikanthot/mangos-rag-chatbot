...
Next.js 14 + React 18 + TypeScript frontend for the MANGOS Tech Manual Chatbot. Provides a multi-conversation chat interface with SSE streaming, structured citations, feedback, and dark mode.
