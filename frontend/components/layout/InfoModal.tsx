...
const RELEASES = [
  {
    ...
    items: [
      ...
      "Dark mode support with MANGOS brand-consistent color palette.",
...
const FEATURES = [
  {
    ...
    description:
      "Searches across indexed MANGOS technical manuals using hybrid vector + keyword retrieval.",
  },
  {
    emoji: "\uD83D\uDCC4",
    bgColor: "#ffedd5",
    ...
    >
      ...
      >
          ...
          {activeTab === "usage" && (
            <div>
              ...
              >
                ...
                <li>
                  Type your question about MANGOS technical manuals in the input box
                  at the bottom.
                </li>
                <li>
        ...
        >
          ...
          >
            MANGOS {APP_SUBTITLE} {APP_VERSION}
          </span>
          <a
            href={FEEDBACK_URL}
            target="_blank"
