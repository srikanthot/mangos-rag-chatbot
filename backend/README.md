...
Python/FastAPI backend for the MANGOS Tech Manual Chatbot. Implements an agent-pattern RAG pipeline using Azure OpenAI, Azure AI Search, and Azure Cosmos DB.
...
- Python 3.10+
- Azure OpenAI deployment (commercial Azure)
